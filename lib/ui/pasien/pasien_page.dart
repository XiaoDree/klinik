...
import '/model/database.dart'; // Mengimpor file database.dart yang berisi definisi kelas Database.
import '/model/pasien.dart'; // Mengimpor file pasien.dart yang berisi definisi kelas Pasien.
